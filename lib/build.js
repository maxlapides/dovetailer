...
Build.prototype.cleanSpecialChars = function() {
    ...
    function encodeEntities(html) {
        ...
        // in the case that there are quotation marks inside an HTML attribute
        // we want those quotation marks to be actual quotation marks
        // ex: replace <a href="hello &quot;world&quot;"> with <a href='hello "world"'>
